...
const uint16_t PROGMEM odot_combo[] = {KC_DOT, KC_O, COMBO_END};
...
//	[RF_TAB]   = COMBO(rf_combo, KC_TAB),
	...
	[ODOT_ENTER] = COMBO(odot_combo, KC_ENTER),
...
// left hand
[0] = LAYOUT_ergodox(
  KC_NO,      KC_1,         KC_2,          KC_3,         KC_4,          KC_5,       LGUI(KC_BSLS),
  KC_ESC,     KC_Q,         KC_W,          KC_F,         LT(4,KC_P),    KC_G,       KC_INS,
  KC_COMMA,   KC_A,         KC_R,          KC_S,         KC_T,          LT(2,KC_D),    
...
// right hand						
  LCA(KC_UP),    KC_6,         KC_7,          KC_8,         KC_9,          KC_0,            KC_NO, 
  LCA(KC_DOWN),  KC_J,         KC_L,          KC_U,         KC_Y,          RALT(KC_P),      KC_SCOLON, 
                 KC_H,         KC_N,          KC_E,         KC_I,          KC_O,            KC_DOT,     
  MO(3),         RSFT_T(KC_K), RGUI_T(KC_M),  RALT(KC_W),   RALT(KC_Q),    RCTL_T(KC_SLSH), KC_QUOTE, 
