 ...
 *
 * ,--------------------------------------------------.           ,--------------------------------------------------.
 * |  TAB   |  F1  |  F2  |  F3  |  F4  |  F5  |GUI \ |           |LSFT Q|  F6  |  F7  |  F8  |  F9  | F10  |  F11   |
 * |--------+------+------+------+------+-------------|           |------+------+------+------+------+------+--------|
 * |  GUI   |  Q   |  W   |  F   |      |      |      |           |CTRL+ |  J   |  L   |  U   |  Y   |  Ö   |   ;    |
 * |--------+------+------+------+------+------|      |           |ALT+UP|------+------+------+------+------+--------|
 * |        |      |      |      |      |      |------|           |------|  H   |  E   |  E   |  I   |  O   |   .    |
 * |--------+------+------+------+------+------|      |           |CTRL+ |------+------+------+------+------+--------|
 * |        |      |      |      |      |      |      |           |ALT+DN|  K   |  M   |  Å   |  Ä   |   /  |   '    |
...
[0] = LAYOUT_ergodox(
  ...
  KC_COMM,   KC_A,         KC_R,          KC_S,         KC_T,          LT(2,KC_D),    
  KC_LGUI,         LCTL_T(KC_Z), LALT_T(KC_X),  RALT_T(KC_C), LGUI_T(KC_V),  LT(4,KC_B), KC_DEL,  
  KC_LCTL,  KC_LALT,  KC_APP,  MO(3),  LSFT_T(KC_COMMA), 
...
// right hand						
 ...
 LCA(KC_UP),       KC_J,         KC_L,          KC_U,         KC_Y,          RALT(KC_P),      KC_SCLN, 
                   LT(3,KC_H),         KC_N,          KC_E,         KC_I,          KC_O,            KC_DOT,     
