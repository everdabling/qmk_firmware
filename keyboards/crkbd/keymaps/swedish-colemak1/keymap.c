...
//	[ENR_SCOLON] = COMBO(enr_combo,    KC_SCOLON),
	[RSE_COMMA]  = COMBO(rse_combo,    KC_COMMA),
	[RSI_DOT]  = COMBO(rsi_combo,    KC_DOT),
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  LGUI_T(SE_COMM), KC_A,         KC_R,         KC_S,          KC_T,             KC_D,              KC_H,         KC_N,         KC_E,    KC_I,    KC_O,           RGUI_T(SE_DOT) ,\
  SE_ACUT,         LCTL_T(KC_Z), LALT_T(KC_X), RALT_T(KC_C),  KC_V,             LT(_I3SWAY,KC_B),  RSFT_T(KC_K), KC_M, SE_ARNG, SE_ADIA, RCTL_T(SE_DOT), SE_SLSH,\
